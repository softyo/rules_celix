/*
  This file was generated automatically by CMake in upstream libzip
  from zip.h and zipint.h; make changes there. This copy is hand-authored to
  match the output of GenerateZipErrorStrings.cmake for libzip 1.10.1 and is
  injected into lib/ via the configs.patch in third_party/libzip.
*/
