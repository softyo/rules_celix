...
def celix_bundle(name, activator, symbolic_name, version = "0.0.0", bundle_name = "", **kwargs):
    ...
    Args:
        ...
        version (str): OSGi `Bundle-Version` header value. Defaults to `"0.0.0"`.
        bundle_name (str): OSGi `Bundle-Name` header value. Defaults to symbolic_name if unset.
